...
Patch6022:    backport-fix-boot-options-generated-by-dracut-module.patch 
...
%changelog
* Fri Oct 29 2021 zhujunhao <zhujunhao8@huawei.com> - 33.19-20
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:fix boot options generated by dracut module

* Sat Aug 7 2021 zhujunhao <zhujunhao8@huawei.com> - 33.19-19
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:dalete date zone map
